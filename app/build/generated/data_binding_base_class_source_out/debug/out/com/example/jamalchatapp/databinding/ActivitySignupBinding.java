...
public final class ActivitySignupBinding implements ViewBinding {
  ...
  @NonNull
  public final CircleImageView cardView;
  ...
  private ActivitySignupBinding(@NonNull ConstraintLayout rootView,
      @NonNull CircleImageView cardView, @NonNull EditText editPass, @NonNull EditText edtemail,
      @NonNull EditText edtname, @NonNull ConstraintLayout main, @NonNull Button signupbtn) {
  ...
  public static ActivitySignupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cardView;
      CircleImageView cardView = ViewBindings.findChildViewById(rootView, id);
      if (cardView == null) {
        break missingId;
      }
